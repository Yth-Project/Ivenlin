  ...
  <div class="app-container app-container-table">
    <div class="app-warpper">
      ...
      <div class="app-header">
        <el-button type="primary" size="small" :disabled="loading" @click="handleDialog(0)">添加供应商</el-button>

        <el-button type="delete" size="small" :disabled="loading" @click="handleDialog(1)">批量删除供应商</el-button>
        <el-select v-model="select" style="margin-left:55px;" size="small" slot="prepend" placeholder="请选择">
          <el-option label="亚马逊" value="1"></el-option>
          <el-option label="京东" value="2"></el-option>
          <el-option label="天猫" value="3"></el-option>
          <el-option label="淘宝" value="4"></el-option>
        </el-select>
        

        <el-button type="select" size="small" style='margin-left:15px;' :disabled="loading" @click="handleDialog(2)">供应商查询</el-button>
      </div>
    ...
    <el-dialog title="编辑供应商" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="供应商名称:" :label-width="'120px'">
          <el-input v-model="form.account" autocomplete="off" />
        </el-form-item>
         <el-form-item label="主营业务:" :label-width="'120px'">
          <el-input v-model="form1.account" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item label="电话号码:" :label-width="'120px'">
          <el-input v-model="form2.account" autocomplete="off" />
        </el-form-item>
        <el-form-item label="银行卡号:" :label-width="'120px'">
          <el-input v-model="form3.account" autocomplete="off" />
        </el-form-item>

        <el-form-item label="主营业务:" :label-width="'120px'">
          <el-input v-model="form4.account" autocomplete="off" />
        </el-form-item>
        <el-form-item label="所在职务:" :label-width="'120px'">
          <el-input v-model="form5.account" autocomplete="off" />
        </el-form-item>
        <el-form-item label="设置密码:" :label-width="'120px'">
          <el-input v-model="form6.account" autocomplete="off" />
        </el-form-item>
        <el-form-item label="公司地址:" :label-width="'120px'">
          <el-input v-model="form7.account" autocomplete="off" />
        </el-form-item>
