  ...
  <div class="navbar">
    <div style="display:flex;max-height:50px;">
      ...
      <div style="flex:1">
        ...
        <div class="right-menu font-small" style="color:#606266"><span> {{userObj.companyCode}}</span></div>
      </div>
      <div style="flex:1">
              ...
              <router-link to="/info/user">
                <el-dropdown-item>
                  <div class="flex-box">
                    ...
                    <span class="flex-item right color-red">1</span>
                  </div>
                </el-dropdown-item>
              </router-link>
...
export default {
  ...
  computed: {
    ...mapGetters(['sidebar', 'avatar', 'userObj'])
  },
  methods: {
    toggleSideBar() {
